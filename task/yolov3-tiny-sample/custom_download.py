...
DOWNLOAD_MAP = {
    ...
    "yolov3-spp": {
        "weight": "https://pjreddie.com/media/files/yolov3-spp.weights",
        "config": "https://raw.githubusercontent.com/AlexeyAB/darknet/master/cfg/yolov3-spp.cfg",
    },
    "yolov4": {
    ...
    "yolov4-csp": {
        "weight": "https://github.com/AlexeyAB/darknet/releases/download/darknet_yolo_v4_pre/yolov4-csp.weights",
        "config": "https://raw.githubusercontent.com/AlexeyAB/darknet/master/cfg/yolov4-csp.cfg",
    },
    "yolov4-p5": {
        "weight": "https://github.com/AlexeyAB/darknet/releases/download/darknet_yolo_v4_pre/yolov4-p5.weights",
        "config": "https://raw.githubusercontent.com/AlexeyAB/darknet/master/cfg/yolov4-p5.cfg",
    },
    "yolov4x-mish": {
