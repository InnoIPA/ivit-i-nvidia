...
class Counting(App):
    ...
    def __call__(self, frame, info):
        ...
        #         cv2.putText(frame, str(idx), (pt[0]-(wid//2), pt[1]+(hei//2)), FONT, FONT_SCALE, COLOR, FONT_THICKNESS)
        ...
        #     cv2.putText(frame, content, (10, 10+(hei*(label_num+1))+(10*label_num) ), FONT, FONT_SCALE, COLOR, FONT_THICKNESS)
